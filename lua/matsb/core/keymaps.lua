...
-- General Mappings
map.set("n", "<leader>sC", ":nohl<CR>", opts) -- Clear search highlighting
...
map.set("n", "<leader>/", "gcc") -- Commenter
map.set("v", "<leader>/", "gc") -- Commenter
...
-- File Explorer
map.set("n", "<leader>e", ":NvimTreeToggle<CR>", opts) -- Toggle file explorer
